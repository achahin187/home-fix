$(document).ready(function(){$('#clockImage').countdown('2018/8/10').on('update.countdown',function(event){var $this=$(this).html(event.strftime(''
...
+'<div class="clockCard p-2 mb-3 bg-cyan bg-darken-4 box-shadow-2"> <span>%S</span> <br> <p class="lead mb-0"> Second%!S </p> </div>'))});$('#clockFlat').countdown('2018/8/10').on('update.countdown',function(event){var $this=$(this).html(event.strftime(''
...
+'<div class="clockCard p-1"> <span>%S</span> <br> <p class="bg-amber clockFormat lead p-1 mt-1 black"> Second%!S </p> </div>'))});$('#clockMinimal').countdown('2018/8/10').on('update.countdown',function(event){var $this=$(this).html(event.strftime(''
...
+'<div class="clockCard white p-2"> <span>%S</span> <br> <p class="lead white"> Second%!S </p> </div>'))});if($('.comingsoonVideo').length>0){$('.comingsoonVideo').tubular({videoId:'iGpuQ0ioPrM'});}});