...
exports.define=define;exports.require=require;expose(["tinymce/pasteplugin/Utils"]);load('classes/Utils.js');load('classes/Clipboard.js');load('classes/WordFilter.js');load('classes/Quirks.js');load('classes/Plugin.js');writeScripts();})(this);