...
exports.define=define;exports.require=require;load('classes/Utils.js');load('classes/TableGrid.js');load('classes/Quirks.js');load('classes/CellSelection.js');load('classes/Dialogs.js');load('classes/ResizeBars.js');load('classes/Plugin.js');writeScripts();})(this);