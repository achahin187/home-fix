...
mod(CodeMirror);})(function(CodeMirror){"use strict";function toWordList(words){var ret=[];words.split(' ').forEach(function(e){ret.push({name:e});});return ret;}
...
return 'atom'+stt.state;}}};});CodeMirror.defineMIME("text/x-forth","forth");});