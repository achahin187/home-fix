...
state.commandMode=-1;else
state.commandMode=2;}
if((ch==="(")||(ch==="\u0009"))
state.label=false;if(ch===";"){stream.skipToEnd();return "comment";}
...
return{startState:function(){return{label:false,commandMode:0};},token:function(stream,state){var style=tokenBase(stream,state);if(state.label)return "tag";return style;}};});CodeMirror.defineMIME("text/x-mumps","mumps");});