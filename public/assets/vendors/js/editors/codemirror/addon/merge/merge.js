...
function copyChunk(dv,to,from,chunk){if(dv.diffOutOfDate)return;var editStart=chunk.editTo>to.lastLine()?Pos(chunk.editFrom-1):Pos(chunk.editFrom,0)
...
CodeMirror.on(widget,"click",clear);return{mark:mark,clear:clear};}
