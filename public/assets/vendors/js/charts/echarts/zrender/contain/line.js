define(function(){return{containStroke:function(x0,y0,x1,y1,lineWidth,x,y){if(lineWidth===0){return false;}
...
var tmp=_a*x-y+_b;var _s=tmp*tmp/(_a*_a+1);return _s<=_l/2*_l/2;}};});