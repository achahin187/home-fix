...
@section('title') {{ __('admin.worker_management') }} @endsection

@section('content-header')
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title">{{ __('admin.worker_management') }}</h3>
...
@section('content')
    <section id="file-export">
                ...
                <div class="card btn-non">
                    ...
                    <div class="card-content collapse show">
                        <div class="float-md-left m-2" style="color:white">
                            <a href="{{ route('export') }}" class="btn btn-info round box-shadow-2">
                        ...
                        <div class="card-body card-dashboard">
                            <table style="width:100%"
                                ...
                                <tbody>
                                    ...
                                    @foreach ($workers as $worker)
                                        <tr class="text-center" id="tr_{{ $worker->id }}" @if (changeUnverifiedWorkerColor($worker->id)) style="background:#ffebee;background:#ffebeecc" @endif>
                                                ...
                                                @section('before_end')
                                                    ...
                                                    <script>
                                                        $('#review-stars_{{ $worker->id }}').raty({
                                                            ...
                                                            hints: [
                                                                "@lang('admin.the_review'): " +
                                                                "{{ round($worker->review, 2) }}",
                                                                "@lang('admin.the_review'): " +
                                                                "{{ round($worker->review, 2) }}",
                                                                "@lang('admin.the_review'): " +
                                                                "{{ round($worker->review, 2) }}",
                                            ...
                                            <th>
                                                <a
                                                    href="{{ route('users.orders', $worker->id) }}">{{ count($worker->workerOrders) }}</a>
                                            </th>
                                            ...
                                            <th class="text-center">
                                                <a id="tr_{{ $worker->id }}" href="#" class="ban_user"
                                                    ...
                                                    @if ($worker->ban == false) data-confirm-message="@lang("admin.ban_confirm|role:admin.the_worker")"
                                                ...
                                                @else
                                                        ...
                                                        <i class="ft-x-circle" style="color:red"></i> @endif </a>
                                                    <a id="tr_{{ $worker->id }}" href="#" class="verify_user"
                                                        style="padding: 0.25vw;"
                                                        data-url="{{ route('verify.user', $worker->id) }}"
                                                        data-cancel="@lang('admin.cancel')"
                                                        data-token="{{ csrf_token() }}" @if ($worker->verified == false) data-confirm-message="@lang("admin.verify_confirm|role:admin.the_worker")"
                                                ...
                                                @else
                                                        ...
                                                        <i class="ft-user-check" style="color:green"></i> @endif
                                                        </a>
                                                ...
                                                @else
                                                    ...
                                                    data-ok="@lang('admin.send activation_key')"
                                                    title="@lang('admin.send activation_key')">
                                                    <i class="far fa-paper-plane" style="color:green"></i> @endif
                                                            </a>
                                            </th>
                                            <th style="border-right: 1px solid #E3EBF3">
                                                <a href="{{ route('workers.edit', $worker->id) }}" style="padding: 0.25vw;"
                                                    title="@lang('admin.edit')" class="btn btn-success">
                                                    <i class="ft-edit"></i>
                                                </a>
                                                <a href="{{ route('workers.show', $worker->id) }}" style="padding: 0.25vw;"
                                                    title="@lang('admin.view')" class="btn btn-info">
                                                    <i class="ft-eye"></i>
                                                </a>
                                                <a id="tr_{{ $worker->id }}" href="#"
                                                    class="delete_record btn btn-danger" style="padding: 0.25vw;"
                                                    data-url="{{ route('workers.destroy', $worker->id) }}"
                                                    data-confirm-message="@lang("
                                                    admin.delete_confirm|role:admin.the_worker")"
                                                    data-success-message="@lang("
                                                    admin.delete_success|role:admin.the_worker")"
                                                    data-error-message="@lang(" admin.delete_error|role:admin.the_worker")"
                                                    data-ok="@lang('admin.delete')" data-cancel="@lang('admin.cancel')"
                                                    data-token="{{ csrf_token() }}" title="@lang('admin.delete')">
                            ...
                            <button class="btn btn-info" id="select_all" style="margin-top: 1%;padding: 1%;">
                                @lang('admin.select_all')</button>
                            <button class="btn btn-info" id="deselect_all" style="margin-top: 1%;padding: 1%;">
                                @lang('admin.deselect_all')</button>
                            <button class="btn btn-danger" id="delete_all"
                                data-confirm-message="@lang('admin.delete_all_confirmation')" data-page="/workers/"
                                data-token="{{ csrf_token() }}" style="margin-top: 1%;padding: 1%;">
        ...
        <!---- modal for import excel workers--->
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">@lang('admin.import_workers')</h5>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary">@lang('admin.import_workers')</button>
                        </form>
