    ...
    <div class="content-header-right col-md-6 col-12">
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                <a class="dropdown-item" href="{{route('sub.edit', $category->id)}}">
                ...
                <a id="tr_{{$category->id}}" href="#" class="delete_record dropdown-item"
                   ...
                   data-redirect="{{route('categories.show', $category->parent_id)}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="card border-bottom-info box-shadow-1 border-bottom-2">
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <span><strong>@lang('admin.checkup_price')</strong></span> :
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group row">
                                                                                            ...
                                                                                            <label class="col-md-4 label-control" for="name"
                                                                                                   style="padding: 0.75rem 1rem;">{{ getPriceByCountry($category->checkup->id, $country->id) }} </label>
