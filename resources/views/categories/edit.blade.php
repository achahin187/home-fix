            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content collpase show">
                        <div class="card-body">
                            <form novalidate method="POST" action="{{ route('categories.update', $category->id) }}"
                                                                        ...
                                                                        <fieldset>
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input id="price[{{$country->id}}]" type="number" min="0" step="0.01"
                                                                                       ...
                                                                                       value="@if (old('price.'.$country->id)){{ old('price.'.$country->id) }}@else{{ getPriceByCountry($category->quick->id, $country->id) }}@endif"
