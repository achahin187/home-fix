...
@section('title') {{ __('admin.Partners_management')}} @endsection

@section('content-header')
    <div class="content-header-left col-md-6 col-12 mb-2">
        <h3 class="content-header-title">{{ __('admin.Partners_management')}}</h3>
        ...
        <div class="btn-group float-md-right" role="group" aria-label="Button group with nested dropdown">
            <a href="{{ route('partners.create') }}">
                <button class="btn btn-info round box-shadow-2 px-2"
                        type="button"><i class="ft-edit icon-left"></i>@lang('admin.add_Partners')
                </button>
            </a>
        </div>
    </div>
                                ...
                                @foreach($sliders as $slider)
                                    <tr class="text-center" id="tr_{{ $slider->id }}">
                                        ...
                                        <th style="border-right: 1px solid #E3EBF3">
                                            <a href="{{route('partners.edit', $slider->id)}}"
                                               style="padding: 0.25vw;"
                                               title="@lang('admin.edit')" class="btn btn-success">
                                                <i class="ft-edit"></i>
                                            </a>
                                            <a href="{{route('partners.show', $slider->id)}}"
                                               style="padding: 0.25vw;"
